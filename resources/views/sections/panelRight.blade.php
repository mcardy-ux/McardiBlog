                            ...
                            <div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                                ...
                                <div id=gdlr-core-category-background-widget-2 class="widget widget_gdlr-core-category-background-widget akea-widget">
                                    ...
                                    <ul class=gdlr-core-category-background-widget>
                                        <li class=gdlr-core-with-bg style="background-image:url({{asset('img/upload/banner_mini_tecnology.jpg')}});" id="li_2207_0"><a href=#><span class=gdlr-core-category-background-widget-content ><span class=gdlr-core-category-background-widget-title >Programación</span><span class=gdlr-core-category-background-widget-count >1</span></span></a></li>
                                        <li class=gdlr-core-with-bg style="background-image:url({{asset('img/upload/banner_mini_tecnology.jpg')}});" id="li_2207_1"><a href=#><span class=gdlr-core-category-background-widget-content ><span class=gdlr-core-category-background-widget-title >Marketing</span><span class=gdlr-core-category-background-widget-count >1</span></span></a></li>
                                        <li class=gdlr-core-with-bg style="background-image:url({{asset('img/upload/banner_mini_tecnology.jpg')}});" id="li_2207_2"><a href=#><span class=gdlr-core-category-background-widget-content ><span class=gdlr-core-category-background-widget-title >Marca y Diseño</span><span class=gdlr-core-category-background-widget-count >1</span></span></a></li>
                                    </ul>
                                </div>
